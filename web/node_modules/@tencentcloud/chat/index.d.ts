...
declare interface SET_ALL_MESSAGE_READ_OPTIONS {
  /**
   * - TencentCloudChat.instance.TYPES.READ_ALL_C2C_MSG, set one-to-one messages as read.
   * - TencentCloudChat.instance.TYPES.READ_ALL_GROUP_MSG, set group messages as read.
   * - TencentCloudChat.instance.TYPES.READ_ALL_MSG, set all messages as read.
   */
  scope: TencentCloudChat.instance.TYPES;
}
...
declare interface SET_MESSAGE_REMIND_TYPE_OPTIONS {
  ...
  /**
   * - TencentCloudChat.instance.TYPES.MSG_REMIND_ACPT_AND_NOTE，the SDK receives a message and throws a MESSAGE_RECEIVED event to notify the access side, which then sends a notification.
   * - TencentCloudChat.instance.TYPES.MSG_REMIND_ACPT_NOT_NOTE，the SDK receives a message and throws a MESSAGE_RECEIVED event to notify the access side, which then does not send a notification.
   * - TencentCloudChat.instance.TYPES.MSG_REMIND_DISCARD, the SDK rejects a message.
   */
  messageRemindType: TencentCloudChat.instance.TYPES;
}
...
declare interface UPDATE_YOUR_PROFILE_OPTIONS {
  ...
  avatar: string;
  /**
   * - TencentCloudChat.instance.TYPES.GENDER_UNKNOWN: unspecified
   * - TencentCloudChat.instance.TYPES.GENDER_FEMALE: female
   * - TencentCloudChat.instance.TYPES.GENDER_MALE: male
   */
  gender: TencentCloudChat.instance.TYPES;
  /**
   * Status
   */
   ...
   * - TencentCloudChat.instance.TYPES.ALLOW_TYPE_ALLOW_ANY: accept any friend request received automatically without verification
   * - TencentCloudChat.instance.TYPES.ALLOW_TYPE_NEED_CONFIRM: verification is required for friend requests received
   * - TencentCloudChat.instance.TYPES.ALLOW_TYPE_DENY_ANY: reject friend requests received
   */
  allowType: TencentCloudChat.instance.TYPES;
  /**
   ...
   * - TencentCloudChat.instance.TYPES.FORBID_TYPE_NONE (default value): allow the user to initiate a friend request
   * - TencentCloudChat.instance.TYPES.FORBID_TYPE_SEND_OUT: prohibit the user from initiating a friend request
   */
  adminForbidType: TencentCloudChat.instance.TYPES;
  /**
...
declare interface ADD_FRIEND_OPTIONS {
   ...
   * - TencentCloudChat.instance.TYPES.SNS_ADD_TYPE_SINGLE: one-way friend adding (one-way friend relationship: B is on A's friend list, but A is not on B's friend list)
   * - TencentCloudChat.instance.TYPES.SNS_ADD_TYPE_BOTH: two-way friend adding (two-way friend relationship: A and B are on each other's friend list)
   */
  type?: TencentCloudChat.instance.TYPES;
  /**
...
declare interface DELETE_FRIEND_OPTIONS {
   ...
   * - TencentCloudChat.instance.TYPES.SNS_DELETE_TYPE_SINGLE: one-way deletion (only delete B from A's friend list but do not delete A from B's friend list)
   * - TencentCloudChat.instance.TYPES.SNS_DELETE_TYPE_BOTH: two-way deletion (delete A and B from each other's friend lists)
   */
  type?: TencentCloudChat.instance.TYPES;
}
...
declare interface CHECK_FRIEND_OPTIONS {
   ...
   * - TencentCloudChat.instance.TYPES.SNS_CHECK_TYPE_SINGLE: one-way friend verification (check whether B is on A's friend list, but does not check whether A is on B's friend list)
   * - TencentCloudChat.instance.TYPES.SNS_CHECK_TYPE_BOTH: two-way friend verification (check whether A and B are on each other's friend lists)
   */
  type: TencentCloudChat.instance.TYPES;
}
...
declare interface ACCEPT_FRIEND_APPLICATION_OPTIONS {
  ...
  /**
   * Accepting mode.
   * - TencentCloudChat.instance.TYPES.SNS_APPLICATION_AGREE: agree to add as a one-way friend
   * - TencentCloudChat.instance.TYPES.SNS_APPLICATION_AGREE_AND_ADD: agree to add as a two-way friend
   */
  type: TencentCloudChat.instance.TYPES;
}
...
declare interface DELETE_FRIEND_APPLICATION_OPTIONS {
  ...
  /**
   * Friend request type
   * - TencentCloudChat.instance.TYPES.SNS_APPLICATION_SENT_TO_ME: friend request received by me
   * - TencentCloudChat.instance.TYPES.SNS_APPLICATION_SENT_BY_ME: friend request sent by me
   */
  type: TencentCloudChat.instance.TYPES;
}
...
declare interface CREATE_GROUP_OPTIONS {
   ...
   * - TencentCloudChat.instance.TYPES.GRP_WORK (default value): work group
   * - TencentCloudChat.instance.TYPES.GRP_PUBLIC: public group
   * - TencentCloudChat.instance.TYPES.GRP_MEETING: meeting group
   * - TencentCloudChat.instance.TYPES.GRP_AVCHATROOM: audio-video group
   */
  type: TencentCloudChat.instance.TYPES;
  /**
   ...
   * - TencentCloudChat.instance.TYPES.JOIN_OPTIONS_FREE_ACCESS: allow free group joining
   * - TencentCloudChat.instance.TYPES.JOIN_OPTIONS_NEED_PERMISSION: require approval for group joining
   * - TencentCloudChat.instance.TYPES.JOIN_OPTIONS_DISABLE_APPLY: forbid group joining
   */
  joinOption?: TencentCloudChat.instance.TYPES;
  /**
...
declare interface JOIN_GROUP_OPTIONS {
   ...
   * - TencentCloudChat.instance.TYPES.GRP_MEETING, Meeting group
   * - TencentCloudChat.instance.TYPES.GRP_AVCHATROOM, Audio-video group
   * - TencentCloudChat.instance.TYPES.GRP_COMMUNITY, Community group
   */
  type?: TencentCloudChat.instance.TYPES;
}
...
declare interface SET_GROUP_MEMBER_ROLE_OPTIONS {
  ...
  /**
   * Valid values:
   * - TencentCloudChat.instance.TYPES.GRP_MBR_ROLE_ADMIN (group admin)
   * - TencentCloudChat.instance.TYPES.GRP_MBR_ROLE_MEMBER (common group member)
   */
  role: TencentCloudChat.instance.TYPES;
}
...
declare interface MESSAGE_OPTIONS {
   ...
   * - TencentCloudChat.instance.TYPES.CONV_C2C (one-to-one chat)
   * - TencentCloudChat.instance.TYPES.CONV_GROUP (group chat)
   */
  conversationType: TencentCloudChat.instance.TYPES;
  /**
   * Message priority
   */
  priority?: TencentCloudChat.instance.TYPES;
  /**
...
export declare interface Conversation {
   ...
   * - TencentCloudChat.instance.TYPES.CONV_C2C, one-to-one chat
   * - TencentCloudChat.instance.TYPES.CONV_GROUP, group chat
   * - TencentCloudChat.instance.TYPES.CONV_SYSTEM, system conversation
   */
  type: TencentCloudChat.instance.TYPES;
  /**
   * Unread message count. TencentCloudChat.instance.TYPES.GRP_MEETING and TencentCloudChat.instance.TYPES.GRP_AVCHATROOM groups do not support the unread count feature, and this field is 0 for them.
   */
  unreadCount: number;
  /**
...
export declare interface Group {
   ...
   * - TencentCloudChat.instance.TYPES.GRP_WORK, Work group
   * - TencentCloudChat.instance.TYPES.GRP_PUBLIC, Public group
   * - TencentCloudChat.instance.TYPES.GRP_MEETING, Meeting group
   * - TencentCloudChat.instance.TYPES.GRP_AVCHATROOM, Audio-video group
   * - TencentCloudChat.instance.TYPES.GRP_COMMUNITY, Community group
   ...
   * - TencentCloudChat.instance.TYPES.JOIN_OPTIONS_FREE_ACCESS: allow free group joining. This is the fixed value for audio-video groups.
   * - TencentCloudChat.instance.TYPES.JOIN_OPTIONS_NEED_PERMISSION: require approval for group joining.
   * - TencentCloudChat.instance.TYPES.JOIN_OPTIONS_DISABLE_APPLY: forbid group joining. This is the fixed value for work groups.
   */
  joinOption: TencentCloudChat.instance.TYPES;
  /**
   * Group custom field.
...
export declare interface Profile {
   ...
   * - TencentCloudChat.instance.TYPES.ALLOW_TYPE_ALLOW_ANY: automatically accept all friend requests received
   * - TencentCloudChat.instance.TYPES.ALLOW_TYPE_NEED_CONFIRM: manually accept friend requests received
   * - TencentCloudChat.instance.TYPES.ALLOW_TYPE_DENY_ANY: automatically reject all friend requests received
   */
  allowType: TencentCloudChat.instance.TYPES;
  /**
  ...
  /**
   * Whether the admin prohibits the user from initiating a friend request
   * - TencentCloudChat.instance.TYPES.FORBID_TYPE_NONE: allow the user to initiate a friend request (default value)
   * - TencentCloudChat.instance.TYPES.FORBID_TYPE_SEND_OUT: prohibit the user from initiating a friend request
   */
  adminForbidType: TencentCloudChat.instance.TYPES;
  /**
...
export declare interface FriendApplication {
  /**
   * User ID
   * - If type is TencentCloudChat.instance.TYPES.SNS_APPLICATION_SENT_TO_ME, userID is the ID of the user who initiates the request.
   * - If type is TencentCloudChat.instance.TYPES.SNS_APPLICATION_SENT_BY_ME, userID is the ID of the user who receives the request.
   */
  userID: string;
  /**
...
export declare interface Signaling {
   ...
   * - TencentCloudChat.instance.TSignaling.ACTION_TYPE_INVITE: invitees initiate the invitation
   * - TencentCloudChat.instance.TSignaling.ACTION_TYPE_CANCEL_INVITE: invitees cancel invitations
   * - TencentCloudChat.instance.TSignaling.ACTION_TYPE_ACCEPT_INVITE: invitees accept the invitation
   * - TencentCloudChat.instance.TSignaling.ACTION_TYPE_REJECT_INVITE: invitees reject the invitation
   * - TencentCloudChat.instance.TSignaling.ACTION_TYPE_INVITE_TIMEOUT: invitation timeout
   */
  actionType: TencentCloudChat.instance.TSignaling;
  /**
   * Signaling timeout
   */
  timeout: number;
...
export declare class ChatSDK {
   ...
   * - After successful login, to call APIs that require authentication, such as sendMessage, you must wait until the SDK enters the ready state (you can obtain the status of the SDK by listening to the TencentCloudChat.instance.EVENT.SDK_READY event).<br/>
   * - By default, multi-instance login is not supported. If you use an account that has been logged in on another page to log in on the current page, the account may be forcibly logged out on the other page, which will trigger the TencentCloudChat.instance.EVENT.KICKED_OUT event. You can proceed accordingly after detecting the event through listening.
   ...
   * @param eventName - Event name. All event names are stored in the TencentCloudChat.instance.EVENT variable.
   ...
   * TencentCloudChat.instance.EVENT.SDK_READY: triggered when the SDK is in the ready state
   * TencentCloudChat.instance.EVENT.SDK_NOT_READY: triggered when the SDK is in the not ready state
   * - To receive a newly pushed one-to-one message, group message, group notification, or group system message, you need to listen for the TencentCloudChat.instance.EVENT.MESSAGE_RECEIVED event.
   * - Messages sent by this API do not trigger the TencentCloudChat.instance.EVENT.MESSAGE_RECEIVED event. Messages sent by the same account from other clients (or through the RESTful API) trigger the TencentCloudChat.instance.EVENT.MESSAGE_RECEIVED event.
   ...
   * - After the API is called successfully, the conversation unread count will not change, and the message sender will receive the TencentCloudChat.instance.TYPES.MESSAGE_READ_RECEIPT_RECEIVED callback, which will carry the latest read information of the message.
   */
  ...
  /**
   * Pin/Unpin a conversation to/from top. After this API is called successfully, the conversation list will be sorted again, and the SDK will distribute the TencentCloudChat.instance.EVENT.CONVERSATION_LIST_UPDATED event.
   */
  ...
  /**
   * Rename a conversation group. The SDK will trigger TencentCloudChat.instance.EVENT.CONVERSATION_LIST_UPDATED and TencentCloudChat.instance.EVENT.CONVERSATION_GROUP_LIST_UPDATED.
   */
  ...
  /**
   * Get the friend list in the SDK cache. When a friend list is updated, the SDK distributes the TencentCloudChat.instance.EVENT.FRIEND_LIST_UPDATED event.
   */
  ...
  /**
   * Get the friend request list in the SDK cache. When a friend request list is updated, the SDK distributes the TencentCloudChat.instance.EVENT.FRIEND_APPLICATION_LIST_UPDATED event.
   */
  ...
  /**
   * Get the list of friend lists in the SDK cache. When the list of friend lists is updated, the SDK distributes the TencentCloudChat.instance.EVENT.FRIEND_GROUP_LIST_UPDATED event.
   */
  ...
  /**
   * Create a group.
   * - After creating an audio-video group (TencentCloudChat.instance.TYPES.GRP_AVCHATROOM) via this API, you need to call the joinGroup API to join the group to enable the messaging process.
   */
   ...
   * Work groups (TencentCloudChat.instance.TYPES.GRP_WORK) cannot be searched.
   */
  ...
  /**
   * Transfer a group. Only group owners have the permission to transfer groups. Audio-video groups (TencentCloudChat.instance.TYPES.GRP_AVCHATROOM) cannot be transferred.
   */
  ...
  /**
   * Add group members.
   * - TencentCloudChat.instance.TYPES.GRP_PRIVATE (work group): any group member can invite users to the group and approval by the invitee is not required.
   * - TencentCloudChat.instance.TYPES.GRP_PUBLIC (public group)/TencentCloudChat.instance.TYPES.GRP_MEETING (meeting group): only the app admin can invite users to the group and approval by the invitee is not required.
   * - TencentCloudChat.instance.TYPES.GRP_AVCHATROOM (audio-video chat room): no member (including the app admin) is allowed to invite any user to the group.
   */
  ...
  /**
   * Set the muting duration for a group member. You can mute or unmute a group member. The muting and unmuting features are unavailable for work groups (TencentCloudChat.instance.TYPES.GRP_WORK).
   ...
   * @param eventName - Event name. All event names are stored in the TencentCloudChat.instance.TSignaling variable.
   * @param handler - Event processing method. When an event is triggered, this handler is called to process the event.
   * @param context - Context in which the handler is expected to execute.
   */
...
declare module TencentCloudChat {
   ...
   * };
   * let chat = TencentCloudChat.instance.create(options); // The SDK instance is usually represented by chat
   */
