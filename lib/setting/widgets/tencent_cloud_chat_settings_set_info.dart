  ...
  Widget defaultBuilder(BuildContext context) {
    return TencentCloudChatThemeWidget(
      build: (context, colorTheme, textStyle) => Container(
        ...
        margin: EdgeInsets.only(top: getHeight(16), bottom: getHeight(1)),
...
class TencentCloudChatSettingsSetInfoNameState extends TencentCloudChatState<TencentCloudChatSettingsSetInfoName> {
  ...
  initState() {
    super.initState();
    nickname = widget.userFullInfo.nickName ?? widget.userFullInfo.userID ?? "";
  }
    ...
    return TencentCloudChatThemeWidget(
        build: (context, colorTheme, textStyle) => GestureDetector(
            ...
            child: Container(
                ...
                color: colorTheme.settingBackgroundColor,
                child: Text(nickname, style: TextStyle(color: colorTheme.settingTitleColor, fontSize: textStyle.fontsize_16, fontWeight: FontWeight.w400)))));
  }
}
