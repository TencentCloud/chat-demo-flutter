                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            onClickUser: (memberInfo, tapDetails) {
                              onClickUserName(
                                  tapDetails != null ? Offset(min(tapDetails.globalPosition.dx, MediaQuery.of(context).size.width - 350), min(tapDetails.globalPosition.dy, MediaQuery.of(context).size.height - 470)) : null, memberInfo.userID);
                            },
                            profileWidgetsOrder: const [
