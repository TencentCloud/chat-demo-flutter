...
declare interface SET_MESSAGE_REMIND_TYPE_OPTIONS {
   ...
   * - TencentCloudChat.TYPES.RECEIVE_WITH_OFFLINE_PUSH_EXCEPT_AT，the SDK receives a message and throws a MESSAGE_RECEIVED event to notify the access side, which then does not send a notification except group at-mentions.
   */
