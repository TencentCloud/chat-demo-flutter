...
declare interface GET_GROUP_LIST_OPTIONS {
   ...
   */
  groupProfileFilter: Array<string>;
}
...
declare interface MESSAGE_OPTIONS {
  ...
  to: string;
  /**
   * Conversation type. Valid values: TIM.TYPES.CONV_C2C (one-to-one chat), TIM.TYPES.CONV_GROUP (group chat)
   */
...
declare interface SimplifiedMessage {
  ID: string;
  /**
   * Nickname of the message sender
   */
...
declare interface FriendApplication {
  /**
   * User ID
