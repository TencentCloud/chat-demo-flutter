 ...
 *
 * @note The struct must be allocated with liteav_av_spherical_alloc() and
 ...
 */
AVSphericalMapping *liteav_av_spherical_alloc(size_t *size);
 ...
 */
void liteav_av_spherical_tile_bounds(const AVSphericalMapping *map,
 ...
 */
const char *liteav_av_spherical_projection_name(enum AVSphericalProjection projection);
 ...
 */
int liteav_av_spherical_from_name(const char *name);
/**
 * @}
 * @}
 */
