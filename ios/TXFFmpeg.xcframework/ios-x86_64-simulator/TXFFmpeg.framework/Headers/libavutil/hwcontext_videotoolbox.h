 ...
 */
enum AVPixelFormat liteav_av_map_videotoolbox_format_to_pixfmt(uint32_t cv_fmt);

/**
 * Convert an AVPixelFormat to a VideoToolbox (actually CoreVideo) format.
 * Returns 0 if no known equivalent was found.
 */
uint32_t liteav_av_map_videotoolbox_format_from_pixfmt(enum AVPixelFormat pix_fmt);
