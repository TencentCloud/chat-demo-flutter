 ...
 * DXGI_FORMAT_420_OPAQUE. liteav_av_hwframe_transfer_data() is not supported for
 * this format. Refer to MSDN for details.
 *
 * liteav_av_hwdevice_ctx_create() for this device type supports a key named "debug"
...
typedef struct AVD3D11VADeviceContext {
     ...
     * texture (for liteav_av_hwframe_transfer_data() calls). They do NOT protect
...
typedef struct AVD3D11VAFramesContext {
     ...
     * - this has to be done before calling liteav_av_hwframe_ctx_init()
     *
