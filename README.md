...
### 2. Override Third-Party Dependencies (`dependency_overrides`)  
...
### 3. Downgrade Required Third-Party Libraries  
Some libraries require version downgrades:  
...
#### Step 2: Replace Platform-Switching Logic 
1. **Search** (use regex):  
   ```regex
...
### Step 3: Fix Android/OS Compatibility Check
